...
local _2amodule_name_2a = "nvim-ripgrep.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("nvim-ripgrep.aniseed.core"), autoload("nvim-ripgrep.aniseed.compile"), autoload("nvim-ripgrep.aniseed.fennel"), autoload("nvim-ripgrep.aniseed.fs"), autoload("nvim-ripgrep.aniseed.nvim")
