...
local _2amodule_name_2a = "nvim-ripgrep.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("nvim-ripgrep.aniseed.core"), autoload("nvim-ripgrep.aniseed.fennel"), autoload("nvim-ripgrep.aniseed.fs"), autoload("nvim-ripgrep.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function macros_prefix(code, opts)
  local macros_module = "nvim-ripgrep.aniseed.macros"
  local filename
  do
