...
local _2amodule_name_2a = "nvim-ripgrep.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("nvim-ripgrep.aniseed.compile"), autoload("nvim-ripgrep.aniseed.fennel"), autoload("nvim-ripgrep.aniseed.fs"), autoload("nvim-ripgrep.aniseed.nvim")
