...
local _2amodule_name_2a = "nvim-ripgrep.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("nvim-ripgrep.aniseed.core"), autoload("nvim-ripgrep.aniseed.fs"), autoload("nvim-ripgrep.aniseed.nvim"), autoload("nvim-ripgrep.aniseed.string")
...
local function impl()
  local compiler = require("nvim-ripgrep.aniseed.deps.fennel")
